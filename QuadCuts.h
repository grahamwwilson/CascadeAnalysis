...
enum class QuadCuts {
    GSNumber = 0, 
    PtOne, PtTwo, PtThree, PtFour, Trigger,
    BTagVeto, SIP3DCut, MaxEta, MinEta, 
    MinMll, OffZ, Pt4L, M4LZV, MxCompMll, NUMCUTS
};
...
//        case QuadCuts::MxMinMll:   return "MxMinMll";         // reject events with the smallest lepton pair mass above eg 21 GeV
        ...
        case QuadCuts::MxCompMll:  return "MxCompMll";        // Now min(mll) for 2+2 and min(m3l) for 3+1.
