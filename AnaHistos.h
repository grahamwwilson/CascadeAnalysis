...
TH1D* hCutFlow = new TH1D("hCutFlow", "Trileptons; Cut Flow; Events per bin scaled to 400 inv fb", 24, -1.5, 22.5);   // Can we make these be adjusted automatically according to the enum?
...
TH1D* hXCutFlow = new TH1D("hXCutFlow", "Trileptons; Exclusive Cut Flow; Events per bin scaled to 400 inv fb", 23, -1.5, 21.5);
