...
python analyze.py -w "ZZZ6e" -t 400.0 -l 3.0470e6 -p "WF-V2" -e ${ELMIN} -m ${MUMIN}
python analyze.py -w "ZZZ4e2mu" -t 400.0 -l 9.3569e5 -p "WF-V2" -e ${ELMIN} -m ${MUMIN}
python analyze.py -w "ZZZ2e4mu" -t 400.0 -l 9.3432e5 -p "WF-V2" -e ${ELMIN} -m ${MUMIN}
python analyze.py -w "ZZZ6mu" -t 400.0 -l 3.0365e6 -p "WF-V2" -e ${ELMIN} -m ${MUMIN}
