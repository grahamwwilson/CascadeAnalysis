   ...
   TTreeReaderValue<Double_t> MT2 = {fReader, "MT2"};
   TTreeReaderValue<Double_t> RISR_LEP = {fReader, "RISR_LEP"};
   TTreeReaderValue<Double_t> PTISR_LEP = {fReader, "PTISR_LEP"};
   TTreeReaderValue<Double_t> MS_LEP = {fReader, "MS_LEP"};
   TTreeReaderValue<Double_t> MSV_LEP = {fReader, "MSV_LEP"};
   TTreeReaderValue<Double_t> MQ_LEP = {fReader, "MQ_LEP"};
   TTreeReaderValue<Double_t> gamma_LEP = {fReader, "gamma_LEP"};
   TTreeReaderValue<Double_t> MPa_LEP = {fReader, "MPa_LEP"};
   TTreeReaderValue<Double_t> MPb_LEP = {fReader, "MPb_LEP"};
   TTreeReaderValue<Double_t> MVa_LEP = {fReader, "MVa_LEP"};
   TTreeReaderValue<Double_t> MVb_LEP = {fReader, "MVb_LEP"};
   TTreeReaderValue<Double_t> PTS_CM_LEP = {fReader, "PTS_CM_LEP"};
   TTreeReaderValue<Double_t> MS_S0_LEP = {fReader, "MS_S0_LEP"};
   TTreeReaderValue<Double_t> MV_S0_LEP = {fReader, "MV_S0_LEP"};
   TTreeReaderValue<Double_t> MQ_S0_LEP = {fReader, "MQ_S0_LEP"};
   TTreeReaderValue<Double_t> gamma_S0_LEP = {fReader, "gamma_S0_LEP"};
   TTreeReaderValue<Double_t> MPTilde_LEP = {fReader, "MPTilde_LEP"};
   TTreeReaderValue<Double_t> MSTilde_LEP = {fReader, "MSTilde_LEP"};
   TTreeReaderValue<Double_t> gammaTilde_LEP = {fReader, "gammaTilde_LEP"};
   TTreeReaderValue<Double_t> CosDecayAngle_Pa_LEP = {fReader, "CosDecayAngle_Pa_LEP"};
   TTreeReaderValue<Double_t> CosDecayAngle_Pb_LEP = {fReader, "CosDecayAngle_Pb_LEP"};
   TTreeReaderValue<Double_t> CosDecayAngle_S_LEP = {fReader, "CosDecayAngle_S_LEP"};
   TTreeReaderValue<Double_t> RZPara_LEP = {fReader, "RZPara_LEP"};
   TTreeReaderValue<Double_t> MINV_LEP = {fReader, "MINV_LEP"};
   TTreeReaderValue<Double_t> Mperp_JET = {fReader, "Mperp_JET"};
   TTreeReaderValue<Double_t> gammaT_JET = {fReader, "gammaT_JET"};
   TTreeReaderValue<Double_t> RISR_JET = {fReader, "RISR_JET"};
   TTreeReaderValue<Double_t> PTISR_JET = {fReader, "PTISR_JET"};
   TTreeReaderValue<Double_t> MS_JET = {fReader, "MS_JET"};
   TTreeReaderValue<Double_t> MSV_JET = {fReader, "MSV_JET"};
   TTreeReaderValue<Double_t> MQ_JET = {fReader, "MQ_JET"};
   TTreeReaderValue<Double_t> gamma_JET = {fReader, "gamma_JET"};
   TTreeReaderValue<Double_t> MPa_JET = {fReader, "MPa_JET"};
   TTreeReaderValue<Double_t> MPb_JET = {fReader, "MPb_JET"};
   TTreeReaderValue<Double_t> MVa_JET = {fReader, "MVa_JET"};
   TTreeReaderValue<Double_t> MVb_JET = {fReader, "MVb_JET"};
   TTreeReaderValue<Double_t> PTS_CM_JET = {fReader, "PTS_CM_JET"};
   TTreeReaderValue<Double_t> MS_S0_JET = {fReader, "MS_S0_JET"};
   TTreeReaderValue<Double_t> MV_S0_JET = {fReader, "MV_S0_JET"};
   TTreeReaderValue<Double_t> MQ_S0_JET = {fReader, "MQ_S0_JET"};
   TTreeReaderValue<Double_t> gamma_S0_JET = {fReader, "gamma_S0_JET"};
   TTreeReaderValue<Double_t> MPTilde_JET = {fReader, "MPTilde_JET"};
   TTreeReaderValue<Double_t> MSTilde_JET = {fReader, "MSTilde_JET"};
   TTreeReaderValue<Double_t> gammaTilde_JET = {fReader, "gammaTilde_JET"};
   TTreeReaderValue<Double_t> CosDecayAngle_Pa_JET = {fReader, "CosDecayAngle_Pa_JET"};
   TTreeReaderValue<Double_t> CosDecayAngle_Pb_JET = {fReader, "CosDecayAngle_Pb_JET"};
   TTreeReaderValue<Double_t> CosDecayAngle_S_JET = {fReader, "CosDecayAngle_S_JET"};
   TTreeReaderValue<Double_t> RZPara_JET = {fReader, "RZPara_JET"};
   TTreeReaderValue<Double_t> MINV_JET = {fReader, "MINV_JET"};
   ...
   TTreeReaderValue<Int_t> cascades_tree = {fReader, "cascades_tree"};
   TTreeReaderValue<Int_t> cascades_prod = {fReader, "cascades_prod"};
   TTreeReaderValue<Int_t> cascades_SlepSneu_1stDecay = {fReader, "cascades_SlepSneu_1stDecay"};
   TTreeReaderValue<Int_t> cascades_SlepSneu_2ndDecay = {fReader, "cascades_SlepSneu_2ndDecay"};
   TTreeReaderValue<Int_t> cascades_N2_1stDecay = {fReader, "cascades_N2_1stDecay"};
   TTreeReaderValue<Int_t> cascades_N2_2ndDecay = {fReader, "cascades_N2_2ndDecay"};
   TTreeReaderValue<Int_t> MSlepL = {fReader, "MSlepL"};
   TTreeReaderValue<Int_t> MSneu = {fReader, "MSneu"};
   TTreeReaderValue<Int_t> MN2 = {fReader, "MN2"};
   TTreeReaderValue<Int_t> MC1 = {fReader, "MC1"};
   TTreeReaderValue<Int_t> MN1 = {fReader, "MN1"};
   TTreeReaderValue<Int_t> MP = {fReader, "MP"};
   TTreeReaderValue<Int_t> NSparticleW = {fReader, "NSparticleW"};
   TTreeReaderValue<Int_t> NSparticleZ = {fReader, "NSparticleZ"};
   TTreeReaderValue<Int_t> NSparticlePhoton = {fReader, "NSparticlePhoton"};
   TTreeReaderArray<int> LSPParents = {fReader, "LSPParents"};
   TTreeReaderValue<Int_t> Npartons = {fReader, "Npartons"};
   TTreeReaderValue<Double_t> genweight = {fReader, "genweight"};
   TTreeReaderValue<Double_t> XSec = {fReader, "XSec"};
   TTreeReaderValue<Double_t> Nweight = {fReader, "Nweight"};
