...
python analyze.py -w "ZZZMET1" -t 400.0 -l 1.0725e6 -p "WF-V2"
python analyze.py -w "ZZZMET2" -t 400.0 -l 1.0697e6 -p "WF-V2"
python analyze.py -w "ZZZMET3" -t 400.0 -l 5.4093e5 -p "WF-V2"
python analyze.py -w "ZZZMET4" -t 400.0 -l 1.0720e6 -p "WF-V2"
python analyze.py -w "ZZZMET5" -t 400.0 -l 1.0677e6 -p "WF-V2"
