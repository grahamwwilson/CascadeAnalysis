...
# Set command line configurable parameters. Do python3 program.py -h to see this in action.
    ...
    parser.add_argument("-w", "--which", type=str, default="Sleptons-LSP260", help="LHE filename prefix (str)")
...
def showArgs(nevsToRead, which, target, lumi):
...
# ii)  set values for our program
    ...
    return nevsToRead,which,target,lumi 
